...
![](images/books/A2014Gerstner_LIF_circuit.PNG){.absolute top=90 left=850 width=25%}
...
::: {layout-nrow=1}
![](images/books/2014Gerstner_no_voltage_threshold.PNG){width=500 height=300}
![](images/books/2014Gerstner_no_current_threshold.PNG){width=500 height=300}
:::
...
![](images/books/2014Gerstner-tau_x.PNG){.absolute top=90 left=650 width=40%}
...
![](images/books/2014Gerstner-one_dimensional_reduction_firing_mechanism.PNG)<!-- {.absolute top=90 left=650 width=40%} -->
...
![](images/books/2014Gerstner-AdEx_derivation.PNG){height=200}
...
![](images/books/2014Gerstner-AdEx_derivation_hh.PNG){height=200}
...
![](images/books/2014Gerstner-firing_patterns.PNG){height=300 width=800}
